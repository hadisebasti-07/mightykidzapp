    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex flex-col items-center gap-4">
              <FormLabel className="text-base font-semibold">Gift Image</FormLabel>
              <Avatar className="h-32 w-32 rounded-md border-4 border-muted">
                <AvatarImage src={field.value} alt="Gift image" className="object-cover" />
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl><Input placeholder="Super Sparkle Sticker Pack" {...field} /></FormControl>
              <FormMessage />
            </FormItem>
          )}
        />
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl><Textarea placeholder="A pack of 50 glittery and fun stickers." {...field} /></FormControl>
              <FormMessage />
            </FormItem>
          )}
        />
        ...
        <div className="flex justify-end gap-2">
          ...
          <Button type="submit">{giftToEdit ? 'Save Changes' : 'Create Gift'}</Button>
        </div>
      </form>
    </Form>
  );
