...
import { FunctionDeclaration, ToolConfig } from './types.mjs';
 ...
 * A tool that can be used by the model.
 */
declare type InteractionTool = InteractionFunctionTool | InteractionGoogleSearchTool | InteractionCodeExecutionTool;
/**
...
export type { AudioContent, Content, CreateInteractionRequest, DeepResearchAgentConfig, DocumentContent, DynamicAgentConfig, FunctionCallContent, FunctionResultContent, GeminiInteraction, ImageConfig, ImageContent, InteractionCodeExecutionTool, InteractionFunctionTool, InteractionGoogleSearchTool, InteractionTool, InteractionsAgentConfig, MediaResolution, ModalityTokens, ModelGenerationConfig, ResponseModality, SpeechConfig, TextContent, ThoughtContent, Turn, Usage, VideoContent };
